...
public class DelayedSpellHolder implements INBTSerializable<ListTag>
{
    ...
    {
        return uuid != null && spells.stream().anyMatch(s -> uuid.equals(s.uuid));
    }
    ...
    public static Optional<DelayedSpellHolder> getHolder(Entity entity)
    {
