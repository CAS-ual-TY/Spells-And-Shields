...
public class BookshelvesRequirement extends Requirement
{
    ...
    public BookshelvesRequirement(IRequirementType.RequirementType type)
    {
        super(type);
    }
    
    public BookshelvesRequirement(IRequirementType.RequirementType type, int bookshelves)
    {
        super(type);
    ...
    public MutableComponent makeDescription(SpellProgressionHolder spellProgressionHolder, ContainerLevelAccess access)
    {
        ...
        return new TranslatableComponent(descriptionId, amount, bookshelves);
    }
