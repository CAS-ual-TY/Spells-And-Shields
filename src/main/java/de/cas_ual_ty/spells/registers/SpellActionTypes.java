...
public class SpellActionTypes
{
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<MoveLivingTargetsAction>> MOVE_LIVING_TARGETS = DEFERRED_REGISTER.register("move_living_targets", () -> new SpellActionType<>(MoveLivingTargetsAction::new, MoveLivingTargetsAction::makeCodec));
