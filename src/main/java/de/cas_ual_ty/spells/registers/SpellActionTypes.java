...
import de.cas_ual_ty.spells.spell.action.team.FilterAlliedTargetsAction;
import de.cas_ual_ty.spells.spell.action.team.FilterEnemyTargetsAction;
import de.cas_ual_ty.spells.spell.action.team.GetTeamAction;
import de.cas_ual_ty.spells.spell.action.team.GetTeamPlayersTargetsAction;
...
public class SpellActionTypes
{
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<HasCooldownAction>> HAS_COOLDOWN = DEFERRED_REGISTER.register("has_cooldown", () -> new SpellActionType<>(HasCooldownAction::new, HasCooldownAction::makeCodec));
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<FindItemTargetsAction>> FIND_ITEM_TARGETS = DEFERRED_REGISTER.register("find_item_targets", () -> new SpellActionType<>(FindItemTargetsAction::new, FindItemTargetsAction::makeCodec));
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<RepairItemAction>> REPAIR_ITEM = DEFERRED_REGISTER.register("repair_item", () -> new SpellActionType<>(RepairItemAction::new, RepairItemAction::makeCodec));
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<TryConsumeItemByTagAction>> TRY_CONSUME_ITEM_BY_TAG = DEFERRED_REGISTER.register("try_consume_item_by_tag", () -> new SpellActionType<>(TryConsumeItemByTagAction::new, TryConsumeItemByTagAction::makeCodec));
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<TryConsumePlayerItemsAction>> TRY_CONSUME_PLAYER_ITEMS = DEFERRED_REGISTER.register("try_consume_player_items", () -> new SpellActionType<>(TryConsumePlayerItemsAction::new, TryConsumePlayerItemsAction::makeCodec));
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<TryConsumeSpecificItemAction>> TRY_CONSUME_SPECIFIC_ITEM = DEFERRED_REGISTER.register("try_consume_specific_item", () -> new SpellActionType<>(TryConsumeSpecificItemAction::new, TryConsumeSpecificItemAction::makeCodec));
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<SetFluidAction>> SET_FLUID = DEFERRED_REGISTER.register("set_fluid", () -> new SpellActionType<>(SetFluidAction::new, SetFluidAction::makeCodec));
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<TryBurnManaAction>> TRY_BURN_MANA = DEFERRED_REGISTER.register("try_burn_mana", () -> new SpellActionType<>(TryBurnManaAction::new, TryBurnManaAction::makeCodec));
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<TryBurnManaCostAction>> TRY_BURN_MANA_COST = DEFERRED_REGISTER.register("try_burn_mana_cost", () -> new SpellActionType<>(TryBurnManaCostAction::new, TryBurnManaCostAction::makeCodec));
    ...
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<FilterLivingTargetsAction>> FILTER_LIVING_TARGETS = DEFERRED_REGISTER.register("filter_living_targets", () -> new SpellActionType<>(FilterLivingTargetsAction::new, FilterLivingTargetsAction::makeCodec));
    public static final DeferredHolder<SpellActionType<?>, SpellActionType<FilterPlayerTargetsAction>> FILTER_PLAYER_TARGETS = DEFERRED_REGISTER.register("filter_player_targets", () -> new SpellActionType<>(FilterPlayerTargetsAction::new, FilterPlayerTargetsAction::makeCodec));
