...
public class SpellActionTypes
{
    ...
    public static final RegistryObject<SpellActionType<ConditionalActivationAction>> CONDITIONAL_ACTIVATION = DEFERRED_REGISTER.register("conditional_activation", () -> new SpellActionType<>(ConditionalActivationAction::new, ConditionalActivationAction::makeCodec));
    public static final RegistryObject<SpellActionType<ConditionalDeactivationAction>> CONDITIONAL_DEACTIVATION = DEFERRED_REGISTER.register("conditional_deactivation", () -> new SpellActionType<>(ConditionalDeactivationAction::new, ConditionalDeactivationAction::makeCodec));
    ...
    public static final RegistryObject<SpellActionType<MovePlayerTargetsAction>> MOVE_PLAYER_TARGETS = DEFERRED_REGISTER.register("move_player_targets", () -> new SpellActionType<>(MovePlayerTargetsAction::new, MovePlayerTargetsAction::makeCodec));
