...
public class SpellTrees
{
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("nether"), Spells.FIRE_BALL, 15, 28, new TranslatableComponent(KEY_NETHER))
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("ocean"), Spells.WATER_BREATHING, 10, 0, new TranslatableComponent(KEY_OCEAN))
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("mining"), Spells.BLAST_SMELT, 5, 8, new TranslatableComponent(KEY_MINING))
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("movement"), Spells.JUMP_BOOST, 15, 12, new TranslatableComponent(KEY_MOVEMENT))
