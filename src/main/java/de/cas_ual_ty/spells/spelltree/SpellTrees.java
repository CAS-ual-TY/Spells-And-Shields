...
public class SpellTrees
{
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("nether"), new TranslatableComponent(KEY_NETHER), Spells.FIRE_BALL, 15, new BookshelvesRequirement(SpellsRegistries.BOOKSHELVES_REQUIREMENT.get(), 28))
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("ocean"), new TranslatableComponent(KEY_OCEAN), Spells.WATER_BREATHING, 10)
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("mining"), new TranslatableComponent(KEY_MINING), Spells.BLAST_SMELT, 5, new BookshelvesRequirement(SpellsRegistries.BOOKSHELVES_REQUIREMENT.get(), 8))
    ...
    {
        return SpellTree.builder(SpellsUtil.generateUUIDForTree("movement"), new TranslatableComponent(KEY_MOVEMENT), Spells.JUMP_BOOST, 15, new BookshelvesRequirement(SpellsRegistries.BOOKSHELVES_REQUIREMENT.get(), 12))
