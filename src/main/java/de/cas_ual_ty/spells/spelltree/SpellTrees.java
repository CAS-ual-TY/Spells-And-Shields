...
public class SpellTrees
{
    ...
    {
        SPELL_TREES_REGISTRY = event.create(new RegistryBuilder<SpellTree>().setMaxID(1024).dataPackRegistry(SpellsCodecs.SPELL_TREE_CONTENTS).setName(new ResourceLocation(MOD_ID, "spell_trees")).onCreate((registry, stage) -> SPELL_TREES_REGISTRY_KEY = registry.getRegistryKey()));
    }
