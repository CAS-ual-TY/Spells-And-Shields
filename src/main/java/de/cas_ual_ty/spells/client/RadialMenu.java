    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        ...
        for(int i = 0; i < slots; i++)
        {
            ...
            if(spell != null)
            {
                ...
                SpellIconRegistry.render(spell.getSpell().value().getIcon(), pPoseStack, iconWidth, iconHeight, Math.round(pos.x), Math.round(pos.y), pPartialTick);
            }
        }
    }
