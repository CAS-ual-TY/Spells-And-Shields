        ...
        dispatcher.register(Commands.literal("spells").requires(css -> css.hasPermission(2))
                ...
                .then(Commands.literal("slots")
                        .then(Commands.literal("set")
                                .then(Commands.argument(ARG_TARGETS, EntityArgument.players())
                                        .then(Commands.argument(ARG_SLOT, IntegerArgumentType.integer(0, SpellHolder.SPELL_SLOTS - 1))
                        ...
                        .then(Commands.literal("remove").then(Commands.argument(ARG_TARGETS, EntityArgument.players()).then(Commands.argument(ARG_SLOT, IntegerArgumentType.integer(0, SpellHolder.SPELL_SLOTS - 1)).executes(SpellCommand::spellsSlotRemove))))
