...
public class LookAtTargetAction extends AffectSingleTypeAction<EntityTarget>
{
    public static Codec<LookAtTargetAction> makeCodec(SpellActionType<LookAtTargetAction> type)
    {
        return RecordCodecBuilder.create(instance -> instance.group(
                ...
                Codec.FLOAT.optionalFieldOf(ParamNames.paramDoubleImm("bb_inflation")).xmap(o -> o.orElse(0F), Optional::of).forGetter(LookAtTargetAction::getBbInflation),
                SpellsUtil.namedEnumCodec(SpellsUtil::blockFromString, SpellsUtil::blockToString).optionalFieldOf("block_clip_context").xmap(o -> o.orElse(ClipContext.Block.COLLIDER), Optional::ofNullable).forGetter(LookAtTargetAction::getBlock),
                SpellsUtil.namedEnumCodec(SpellsUtil::fluidFromString, SpellsUtil::fluidToString).optionalFieldOf("fluid_clip_context").xmap(o -> o.orElse(ClipContext.Fluid.NONE), Optional::ofNullable).forGetter(LookAtTargetAction::getFluid),
