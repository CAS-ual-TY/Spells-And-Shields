...
public class SpellsGen implements DataProvider
{
    ...
    protected void addSpells()
    {
        ...
        addSpell(Spells.LEAP, new Spell(modId, "leap", Spells.KEY_LEAP, 2.5F)
                ...
                // y <- vector.y = look.y
                .addAction(new MappedUnaryVarAction(SpellActionTypes.Y.get(), BuiltinActivations.ACTIVE.activation, "vector", "y", SpellActionTypes.Y_MAP))
                // neg <- -1
                ...
                // y2 <- y * neg = -y
                .addAction(new MappedBinaryVarAction(SpellActionTypes.MUL.get(), BuiltinActivations.ACTIVE.activation, "y", "neg", "y2", SpellActionTypes.ADD_MAP))
                ...
                .addAction(new MappedBinaryVarAction(SpellActionTypes.ADD.get(), BuiltinActivations.ACTIVE.activation, "vector", "vector2", "vector3", SpellActionTypes.ADD_MAP))
                ...
                // y3 <- y + half
                .addAction(new MappedBinaryVarAction(SpellActionTypes.ADD.get(), BuiltinActivations.ACTIVE.activation, "y", "half", "y3", SpellActionTypes.ADD_MAP))
                // y4 <- max(half, y3) = max(0.5, look.y + 0.5)
                .addAction(new MappedBinaryVarAction(SpellActionTypes.MAX.get(), BuiltinActivations.ACTIVE.activation, "y3", "half", "y4", SpellActionTypes.ADD_MAP))
                // vector5 <- (0, y4, 0)
                ...
                .addAction(new MappedBinaryVarAction(SpellActionTypes.ADD.get(), BuiltinActivations.ACTIVE.activation, "vector4", "vector5", "vector6", SpellActionTypes.ADD_MAP))
